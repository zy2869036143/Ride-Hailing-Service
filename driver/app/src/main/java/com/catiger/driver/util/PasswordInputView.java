...
import com.catiger.driver.R; // 小白注意，这里导入自己项目的R文件，根据实际情况写
...
public class PasswordInputView extends androidx.appcompat.widget.AppCompatEditText{
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        final int defaultBorderColor = res.getColor(R.color.black);
        final float defaultBorderWidth = res.getDimension(R.dimen.activity_horizontal_margin);
        final float defaultBorderRadius = res.getDimension(R.dimen.activity_horizontal_margin);
        final int defaultPasswordLength = 6;
        final int defaultPasswordColor = res.getColor(R.color.black);
        final float defaultPasswordWidth = res.getDimension(R.dimen.activity_horizontal_margin);
        final float defaultPasswordRadius = res.getDimension(R.dimen.activity_horizontal_margin);
